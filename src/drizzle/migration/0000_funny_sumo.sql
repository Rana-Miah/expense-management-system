CREATE TABLE "assign_transaction_name" (
...
ALTER TABLE "assign_transaction_name" ADD CONSTRAINT "assign_transaction_name_transaction_name_id_trx_name_id_fk" FOREIGN KEY ("transaction_name_id") REFERENCES "public"."trx_name"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
